...
public class ConteudoPratylenchusZeae extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private String[] imageUrls = new String[]{
            //Milho
            "https://i.ibb.co/NFxdDyK/parte-a-rea-milho-2.jpg",
            "https://i.ibb.co/XJKZgXY/parte-a-rea-milho-3.jpg",
            "https://i.ibb.co/MZZ9sYF/parte-a-rea-milho.jpg",
            "https://i.ibb.co/qR7fmqG/raiz-milho.jpg",
            "https://i.ibb.co/g6X2mZN/raiz.jpg"
    };
    TextView titulo;
    TextView conteudo;
    WebView wb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conteudo_pratylenchus_zeae);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent c = new Intent(ConteudoPratylenchusZeae.this, Contato.class);
                startActivity(c);
            }
        });
        ...
        wb = findViewById(R.id.webViewZeae);
